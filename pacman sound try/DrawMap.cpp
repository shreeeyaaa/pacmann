...
void draw_map(const std::array<std::array<Cell, MAP_HEIGHT>, MAP_WIDTH>& i_map, sf::RenderWindow& i_window)
{
	...
	//If you have multiple cell sizes or versions of your map, you can reuse the same code to load different texture files by simply changing the CELL_SIZE constant.
